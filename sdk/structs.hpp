...
public:
    ...
    __forceinline bool IsZoomable(bool extra_check = true) {
        return m_iItemDefinitionIndex() == WEAPON_SSG08
            ...
            || (extra_check && (m_iItemDefinitionIndex() == WEAPON_SG553 || m_iItemDefinitionIndex() == WEAPON_AUG));
    }
...
public:
    ...
    //OFFSET(CUtlVector< CBoneCache >, bone_cache, 0x2910);
    OFFSET(CBoneCache, m_bone_cache, 0x2910);
