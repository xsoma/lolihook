...
bool ImGui::ContentTab(const char* label, bool active, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
    ...
    const ImVec4 text_act = ImVec4(255 / 255.f, 0 / 255.f, 255 / 255.f, 1.f);
...
bool ImGui::KeybindButton(const char* label, const char* unique_id, const ImVec2& size_arg, bool clicked, ImGuiButtonFlags flags)
{
    ...
    ImGui::GetWindowDrawList()->AddRect(bb.Min, bb.Max, GetColorU32(ImVec4(255 / 255.f, 0 / 255.f, 255 / 255.f, it_hover->second)), 2.f * c_menu::get().dpi_scale);
...
bool ImGui::CustomButton(const char* label, const char* label_id, const ImVec2& size_arg, bool use_icon, ImFont* icon_font, const char* icon_label)
{
    ...
    const ImVec4 text_act = ImVec4(255 / 255.f, 255 / 255.f, 255 / 255.f, 1.f);
    const ImVec4 icon_act = ImVec4(255 / 255.f, 0 / 255.f, 255 / 255.f, 1.f);

    RenderFrame(bb.Min, bb.Max, col, true, 2.f * c_menu::get().dpi_scale);

    window->DrawList->PushClipRect(bb.Min, bb.Max, false);
    ImGui::GetWindowDrawList()->AddCircleFilled(it_circle->second.pos, it_circle->second.radius, GetColorU32(ImVec4(255 / 255.f, 0 / 255.f, 255 / 255.f, it_circle->second.alpha)), 60);
...
bool ImGui::ScrollbarEx(const ImRect& bb_frame, ImGuiID id, ImGuiAxis axis, float* p_scroll_v, float size_avail_v, float size_contents_v, ImDrawCornerFlags rounding_corners)
{
    ...
    // Render
    ImVec4 hover_dis = ImVec4(255 / 255.f, 0 / 255.f, 255 / 255.f, 1.f);
...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    const ImVec4 hover_act = ImVec4(202 / 255.f, 202 / 255.f, 202 / 255.f, 1.f);
    const ImVec4 hover_dis = ImVec4(255 / 255.f, 0 / 255.f, 255 / 255.f, 1.f);
    ...
    window->DrawList->AddRectFilled(check_bb.Min, check_bb.Max, GetColorU32(ImVec4(255 / 255.f, 0 / 255.f, 255 / 255.f, it_filled->second)), 2.f * c_menu::get().dpi_scale);
...
bool ImGui::BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags, int* current_item)
{
    ...
    const ImVec4 hover_act = ImVec4(255 / 255.f, 0 / 255.f, 255 / 255.f, 1.f);
    ...
    const ImVec4 arrow_act = ImVec4(255 / 255.f, 0 / 255.f, 255 / 255.f, 1.f);
